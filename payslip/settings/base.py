...
# Initialise environment-based configuration
# This is required to avoid having configuration secrets (such as database
# passwords or the secret session key) stored in a public git repository
env = environ.Env()
